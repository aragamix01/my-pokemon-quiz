...
export type MoveTarget = 
  | 'selected-pokemon' | 'all-other-pokemon' | 'user' | 'random-opponent' 
  | 'all-opponents' | 'entire-field' | 'user-or-ally' | 'user-and-allies' 
  | 'all-pokemon' | 'users-field' | 'opponents-field' | 'all-allies'
  | 'specific-move' | 'fainting-pokemon' | 'ally' | 'selected-pokemon-me-first'
